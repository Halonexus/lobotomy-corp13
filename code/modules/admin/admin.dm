...
/datum/admins/proc/show_player_panel(mob/M in GLOB.mob_list)
	...
	var/body = "<!DOCTYPE html><html><head><meta http-equiv='Content-Type' content='text/html; charset=UTF-8'><title>Options for [M.key]</title></head>"
...
/datum/admins/proc/access_news_network() //MARKER
	...
	if (!istype(src, /datum/admins))
		...
		return
	var/dat
	dat = text("<!DOCTYPE html><HEAD><TITLE>Admin Newscaster</TITLE></HEAD><H3>Admin Newscaster Unit</H3>")
