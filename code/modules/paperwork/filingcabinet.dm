...
/obj/structure/filingcabinet/ui_interact(mob/user)
	...
	dat += "</table></center>"
	user << browse("<!DOCTYPE html><html><head><meta http-equiv='Content-Type' content='text/html; charset=UTF-8'><title>[name]</title></head><body>[dat]</body></html>", "window=filingcabinet;size=350x300")
...
/obj/structure/filingcabinet/Topic(href, href_list)
	...
	if(href_list["retrieve"])
		usr << browse("<!DOCTYPE html>", "window=filingcabinet") // Close the menu
