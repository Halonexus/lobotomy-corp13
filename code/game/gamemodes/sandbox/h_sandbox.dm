...
/datum/h_sandbox/proc/update()
	...
	if(!hsbinfo)
		hsbinfo = "<!DOCTYPE html><center><b>Sandbox Panel</b></center><hr>"
		if(admin)
	...
	if(href_list["hsb"])
		switch(href_list["hsb"])
			...
			if("hsbcloth")
				...
				if(!clothinfo)
					clothinfo = "<!DOCTYPE html><b>Clothing</b> <a href='byond://?[REF(src)];hsb=hsbreag'>(Reagent Containers)</a> <a href='byond://?[REF(src)];hsb=hsbobj'>(Other Items)</a><hr><br>"
			...
			if("hsbreag")
				...
				if(!reaginfo)
					reaginfo = "<!DOCTYPE html><b>Reagent Containers</b> <a href='byond://?[REF(src)];hsb=hsbcloth'>(Clothing)</a> <a href='byond://?[REF(src)];hsb=hsbobj'>(Other Items)</a><hr><br>"
			...
			if("hsbobj")
				...
				if(!objinfo)
					objinfo = "<!DOCTYPE html><b>Other Items</b> <a href='byond://?[REF(src)];hsb=hsbcloth'>(Clothing)</a> <a href='byond://?[REF(src)];hsb=hsbreag'>(Reagent Containers)</a><hr><br>"
